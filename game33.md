...
<body translate="no">
  <h1 class="jt --debug">
  <span class="jt__row">
    <span class="jt__text">CodeClimbers</span>
  </span>
...
<script type="text/javascript">
  // Wait for 4 seconds (4000 milliseconds) and then redirect to the GitHub page
  setTimeout(function() {
      window.location.href = "https://gavincopley.github.io/sharedGame/home";
  }, 4000);
</script>
</body>
